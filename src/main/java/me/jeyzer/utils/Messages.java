...
public class Messages {
    ...
    public static String plain(String path) {
        return FoliaTpa.getInstance().getConfiguration().find(Config.LANGUAGE).getString(path);
    }
    ...
    public static Component toComponent(Player target, String path, Object... params) {
        ...
        FileConfiguration config = FoliaTpa.getInstance().getConfiguration().find(Config.LANGUAGE);
    ...
    public static Component toComponent(String path, Object... params) {
        ...
        FileConfiguration storage = FoliaTpa.getInstance().getConfiguration().find(Config.LANGUAGE);
